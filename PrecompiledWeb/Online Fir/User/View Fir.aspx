<%@ page language="C#" autoeventwireup="true" inherits="User_View_Fir, App_Web_ilcyzhmr" %>
           ...
           <div class="col-sm-4"> <b>State Name</b>
            ...
            <div class="col-sm-4">
             ...
             <div class="col-sm-4">             
                       ...
                       <asp:TextBox ID="TextBox1" ReadOnly="true" runat="server" class="form-control"></asp:TextBox></div>
        </div>
         </div> 
              ...
              <div class="col-sm-12">
                  ...
                  <div class="col-sm-4">
                      <b>Occurance Date:</b>
                       ...
                       <asp:TextBox ID="TextBox2" ReadOnly="true" runat="server" class="form-control" TextMode="Date"></asp:TextBox>
                  </div>
                   <div class="col-sm-8">
                       <br />
                       <b>Details:</b>
                       <asp:TextBox ID="TextBox3" ReadOnly="true" runat="server" TextMode="MultiLine" class="form-control" Style="height:250px;"></asp:TextBox>
                          
                  </div>
                   <div class="col-sm-8">
                       <br />
                       <b>Suspect details:</b>
                       <asp:TextBox ID="TextBox4" ReadOnly="true" runat="server" class="form-control" TextMode="MultiLine" style="height:80px;"></asp:TextBox>                 
                   </div>                 
              </div>                            
          </div>
         </div>     
        ...
        <div class="container">
          <div class="row">
              ...
              <div class="col-sm-6">
                  ...
                  <asp:TextBox ID="TextBox6" ReadOnly="true" runat="server" class="form-control"></asp:TextBox>
              </div>
              <div class="col-sm-6">
                  <br />
                  <b>Identification:</b>
                  <asp:TextBox ID="TextBox7" ReadOnly="true" runat="server" class="form-control"></asp:TextBox>
              </div>                 
              <div class="col-sm-6">
                  <br />
                  <b>Caste:</b>
                  <asp:TextBox ID="TextBox8" ReadOnly="true" runat="server" class="form-control"></asp:TextBox>
              </div>
              <div class="col-sm-8">
                  <br />
                  <b>Address:</b>
                  <asp:TextBox ID="TextBox9" ReadOnly="true" runat="server" class="form-control" TextMode="MultiLine" style="height:100px;"></asp:TextBox>
              </div>
              <div class="col-sm-6">
                  <br />
                  <b>Contact Number:</b>
